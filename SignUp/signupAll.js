...
export default class SignUpAll extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      loginType:true,
...
_storeData = async (data,name) => {
  ...
  render() {
    return (
      <View style={{borderColor:"red",borderWidth:0,flex:1,flexDirection:"column",backgroundColor:"#F81894"}}>
